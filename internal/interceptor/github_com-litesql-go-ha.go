...
func init() {
	Symbols["github.com/litesql/go-ha/ha"] = map[string]reflect.Value{
		...
		"NewCompositePublisher":          reflect.ValueOf(ha.NewCompositePublisher),
		"NewConnector":                   reflect.ValueOf(ha.NewConnector),
		"NewDBPublisher":                 reflect.ValueOf(ha.NewDBPublisher),
		"NewDBSubscriber":                reflect.ValueOf(ha.NewDBSubscriber),
		...
		"NewTwoPhaseCommitPublisher":     reflect.ValueOf(ha.NewTwoPhaseCommitPublisher),
		...
		"WithForcePublishBeforeStart":    reflect.ValueOf(ha.WithForcePublishBeforeStart),
		...
		"CompositePublisher":      reflect.ValueOf((*ha.CompositePublisher)(nil)),
		...
		"TwoPhaseCommitPublisher": reflect.ValueOf((*ha.TwoPhaseCommitPublisher)(nil)),
