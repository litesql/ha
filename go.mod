...
require (
	...
	github.com/litesql/go-sqlite-ha v0.13.1
	github.com/litesql/go-sqlite3-ha v0.13.0
	github.com/litesql/mysql v0.0.4
	github.com/litesql/postgresql v0.1.5
...
require (
	...
	github.com/litesql/go-sqlite3 v1.14.53 // indirect
