...
require (
	...
	github.com/litesql/go-sqlite-ha v0.5.6
	github.com/litesql/go-sqlite3-ha v0.5.6
...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260105182714-0f1f7aa89b24 // indirect
